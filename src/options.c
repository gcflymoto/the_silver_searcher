...
#endif
    printf("Features:\n");
    printf("  %cjit %cpcre %cpcre2 %clzma %czlib\n", jit, pcre1, pcre2, lzma, zlib);
}
...
void init_options(void) {
    ...
    opts.search_zip_files = 1; // gcflymoto - check/search compressed files without the need of additional switch
}
